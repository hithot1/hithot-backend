...
const adminapiobj=require("../api/admin_api.js")
...
// ***************** ADMIN ROUTES *************************//
  ...
  // Sounds
  app.post("/api/admin_all_sounds", allBapi.admin_all_sounds, error);
  ...
  // Agency     --file done 
  app.post("/api/getadminAgency", adminapiobj.getadminAgency, error);

  //Banner  --file done 
  app.post("/api/getadminBanner", adminapiobj.getadminBanner, error);
  ...
  // Shots API   ----file done
  app.post("/api/admin_show_allVideos_new",adminapiobj.admin_show_allVideos_new,error);
  // app.post("/api/admin_show_allVideos", adminapiobj.admin_show_allVideos, error);
  app.post("/api/admin_show_allVideosExplore",adminapiobj.admin_show_allVideosExplore,error);
  app.post("/api/admin_show_allVideosForYouMark",adminapiobj.admin_show_allVideosForYouMark,error);
  app.post("/api/admin_show_allVideosMark",adminapiobj.admin_show_allVideosMark,error);
  app.post("/api/admin_show_allVideosForYou",adminapiobj.admin_show_allVideosForYou,error);
  app.post("/api/AdminDeleteVideo", adminapiobj.AdminDeleteVideo, error);

  // Clips API    ----file done
  // app.post("/api/admin_show_allClip", adminapiobj.admin_show_allClip_new, error);
  app.post("/api/admin_show_allVideosForYouClip",adminapiobj.admin_show_allVideosForYouClip,error);

  // Images API   ---------file done 
  // app.post("/api/admin_show_allImages",adminapiobj.admin_show_allImages_new,error);

  // Users API    -----file  done
  app.post("/api/adminUpdateUser", adminapiobj.adminUpdateUser, error);
  app.post("/api/admin_show_allMarkedUser",adminapiobj.admin_show_allMarkedUser,error);
  app.post("/api/admin_show_allacceptdiamondsuser",adminapiobj.admin_show_allacceptdiamondsuser,error);
  app.post("/api/admin_show_allVideos4User",adminapiobj.admin_show_allVideos4User,error);
  app.post("/api/getDiamondUserDashboard",adminapiobj.getDiamondUserDashboard,error);
...
app.post("/api/changePassword", allBapi.changePassword, error);
  ...
  app.post("/api/addVideoAsMark", adminapiobj.addVideoAsMark, error);
  app.post("/api/changeDiscriptionOfVideo",adminapiobj.changeDiscriptionOfVideo,error);
  app.post("/api/addVideointoDiscovery", adminapiobj.addVideointoDiscovery, error);
  app.post("/api/all_discovery_sections",adminapiobj.all_discovery_sections,error);
  app.post("/api/add_discovery_Section", adminapiobj.add_discovery_Section, error);
  app.post("/api/all_list_discovery_sections",adminapiobj.all_list_discovery_sections,error);
  app.post("/api/addForYou", adminapiobj.addForYou, error);
  app.post("/api/addForYouMark", adminapiobj.addForYouMark, error);
  app.post("/api/removefromforyou", adminapiobj.removefromforyou, error);
  app.post("/api/removefromforyouMark", adminapiobj.removefromforyouMark, error);
  app.post("/api/removevideofrommarked", adminapiobj.removevideofrommarked, error);
  app.post("/api/removefrommarked", adminapiobj.removefrommarked, error);
  app.post("/api/removeVideoFromExplore",adminapiobj.removeVideoFromExplore,error);
  app.post("/api/addVideoToExplore", adminapiobj.addVideoToExplore, error);
  app.post("/api/removeSection", adminapiobj.removeSection, error);

  // Clip API        ----file done
  app.post("/api/All_Clip_Users", adminapiobj.All_Clip_Users, error);

  // Images API   ---file donr
  app.post("/api/checkUserName", adminapiobj.checkUserName, error);

  // Upload API
  app.post("/api/uploadSound", adminapiobj.uploadSound, error); 
  app.post("/api/allowUsertoUploadClip", adminapiobj.allowUsertoUploadClip, error);

  // Users API   ---file done 
  app.post("/api/All_Users", adminapiobj.All_Users_new, error);
  app.post("/api/getAllVerifiedDaysByMonth",adminapiobj.getAllVerifiedDaysByMonth,error);
  app.post("/api/getAllVerifiedMonthsByYear",adminapiobj.getAllVerifiedMonthsByYear,error);
  app.post("/api/All_VerifiedUsers", adminapiobj.All_VerifiedUsers, error);
  app.post("/api/getAllUsersVideoAudio", adminapiobj.getAllUsersVideoAudio, error);
  app.post("/api/getAllUsersInfo_", adminapiobj.getAllUsersInfo_, error);
  app.post("/api/getAllUsersByDate", adminapiobj.getAllUsersByDate, error);
  app.post("/api/addfollowers", adminapiobj.addfollowers, error);
  ...
  // Agency    ----file done 
  app.post("/api/All_Users_Agency", adminapiobj.All_Users_Agency, error);
  app.post("/api/getAgency", adminapiobj.getAgency, error);
  app.post("/api/createAgency", adminapiobj.createAgency, error);
  app.post("/api/getAllAgencyAndClipUploader",adminapiobj.getAllAgencyAndClipUploader,error);
  app.post("/api/removeAgency", adminapiobj.removeAgency, error);
  app.post("/api/getAllAgencyInfo_", adminapiobj.getAllAgencyInfo_, error); 

  //Banner  ----file done 
  app.post("/api/addbanner", adminapiobj.addbanner, error);
  app.post("/api/editbanner", adminapiobj.editbanner, error);
  app.post("/api/removebanner", adminapiobj.removebanner, error);
  app.post("/api/orderBanner", adminapiobj.orderBanner, error);
