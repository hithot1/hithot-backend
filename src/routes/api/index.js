...
module.exports = function (app) {
  ...
  app.post(
    "/api/ifParticipateThenStartLive",
    allBapi.ifParticipateThenStartLive,
    error
  );
  ...
  app.post(
    "/api/admin_show_allVideosExplore",
    allBapi.admin_show_allVideosExplore,
    error
  );
  ...
  app.post("/api/All_Users", allBapi.All_Users, error);
  ...
  app.post(
    "/api/allProfileVerification",
    allBapi.allProfileVerification,
    error
  );
  app.post("/api/generateAgoraToken", allBapi.generateAgoraToken, error);
  app.post(
    "/api/get_followers_user_s_user",
    allBapi.get_followers_user_s_user,
    error
  );
  app.post("/api/Admin_Login", allBapi.Admin_Login, error);
  app.post("/api/admin_show_allClip", allBapi.admin_show_allClip, error);
  ...
  app.post(
    ...
    allBapi.updateVerificationStatus,
    error
  );
  app.post(
    "/api/admin_show_allVideos4User",
    allBapi.admin_show_allVideos4User,
    error
  );
  app.post("/api/addFakeViewLike", allBapi.addFakeViewLike, error);
  app.post(
    "/api/all_discovery_sections",
    allBapi.all_discovery_sections,
    error
  );
  ...
  app.post(
    "/api/changeDiscriptionOfVideo",
    allBapi.changeDiscriptionOfVideo,
    error
  );
  ...
  app.post("/api/admin_show_allImages", allBapi.admin_show_allImages, error);
  app.post(
    "/api/admin_show_allVideosForYou",
    allBapi.admin_show_allVideosForYou,
    error
  );
  app.post(
    "/api/admin_show_allVideosForYouClip",
    allBapi.admin_show_allVideosForYouClip,
    error
  );
  app.post(
    "/api/admin_show_allVideosForYouMark",
    allBapi.admin_show_allVideosForYouMark,
    error
  );
  app.post(
    "/api/admin_show_allVideosMark",
    allBapi.admin_show_allVideosMark,
    error
  );
  app.post(
    "/api/admin_show_allMarkedUser",
    allBapi.admin_show_allMarkedUser,
    error
  );
  app.post(
    "/api/admin_show_allacceptdiamondsuser",
    allBapi.admin_show_allacceptdiamondsuser,
    error
  );
  ...
  app.post(
    "/api/all_list_discovery_sections",
    allBapi.all_list_discovery_sections,
    error
  );
  app.post("/api/add_discovery_Section", allBapi.add_discovery_Section, error);
  app.post(
    "/api/admin_show_allFeedback",
    allBapi.admin_show_allFeedback,
    error
  );
  ...
  app.post(
    "/api/getAllVerifiedDaysByMonth",
    allBapi.getAllVerifiedDaysByMonth,
    error
  );
  app.post(
    "/api/getAllVerifiedMonthsByYear",
    allBapi.getAllVerifiedMonthsByYear,
    error
  );
  app.post(
    "/api/getAllAgencyAndClipUploader",
    allBapi.getAllAgencyAndClipUploader,
    error
  );
  app.post(
    "/api/getAllShotsAndClipByYear",
    allBapi.getAllShotsAndClipByYear,
    error
  );
  ...
  app.post("/api/All_Reported_user", allBapi.All_Reported_user, error);
  ...
  app.post(
    "/api/get_followings_user_s_user",
    allBapi.get_followings_user_s_user,
    error
  );
  ...
  app.post(
    "/api/varifiedWithdrawRequest",
    allBapi.varifiedWithdrawRequest,
    error
  );
  ...
  app.post(
    "/api/addUserAsMarkacceptdiamond",
    allBapi.addUserAsMarkacceptdiamond,
    error
  );
  app.post(
    "/api/removefrommarkedacceptdiamondsuser",
    allBapi.removefrommarkedacceptdiamondsuser,
    error
  );
  app.post(
    "/api/upipaymentstatusupdate",
    allBapi.upipaymentstatusupdate,
    error
  );
  app.post(
    "/api/addDiamondsToUserWallet",
    allBapi.addDiamondsToUserWallet,
    error
  );
  app.post(
    "/api/removefromsubscribmarked",
    allBapi.removefromsubscribmarked,
    error
  );
  ...
  app.post(
    "/api/checkatomtechpaymentstatus",
    allBapi.checkatomtechpaymentstatus,
    error
  );
  ...
  app.post(
    "/api/getAddedPanelHashtagList",
    allBapi.getAddedPanelHashtagList,
    error
  );
  app.post(
    "/api/setOrderVideosExploreHashtag",
    allBapi.setOrderVideosExploreHashtag,
    error
  );
  app.post(
    "/api/removeAddedPanelHashtagList",
    allBapi.removeAddedPanelHashtagList,
    error
  );
  ...
  app.post(
    "/api/removeVideoFromExplore",
    allBapi.removeVideoFromExplore,
    error
  );
  ...
  app.post(
    "/api/getDiamondUserDashboard",
    allBapi.getDiamondUserDashboard,
    error
  );
  app.post(
    "/api/getAllCreatorMonthsByYear",
    allBapi.getAllCreatorMonthsByYear,
    error
  );
  app.post(
    "/api/getAllCreatorDaysByMonth",
    allBapi.getAllCreatorDaysByMonth,
    error
  );
  app.post(
    "/api/getWithdrawlUserDashboard",
    allBapi.getWithdrawlUserDashboard,
    error
  );
  app.post(
    "/api/getAllReferralDaysByMonth",
    allBapi.getAllReferralDaysByMonth,
    error
  );
  app.post(
    "/api/getAllReffralMonthsByYear",
    allBapi.getAllReffralMonthsByYear,
    error
  );
  ...
  app.post(
    "/api/sendNotificationFromPanel",
    allBapi.sendNotificationFromPanel,
    error
  );
  app.post("/api/getAllAgencyInfo_", allBapi.getAllAgencyInfo_, error);
  app.post(
    "/api/sendNotificationFromPanelToAgencyUser",
    allBapi.sendNotificationFromPanelToAgencyUser,
    error
  );
  app.post(
    "/api/admin_show_allMarkedsubscribUser",
    allBapi.admin_show_allMarkedsubscribUser,
    error
  );
  ...
  app.post(
    "/api/deleteadminAwardWinner",
    allBapi.deleteadminAwardWinner,
    error
  );
  app.post(
    "/api/changeStatusadminAwardWinner",
    allBapi.changeStatusadminAwardWinner,
    error
  );
  app.post(
    "/api/updateadminAwardWinner_1",
    allBapi.updateadminAwardWinner_1,
    error
  );
  ...
  //**********************************All CLips*************************** *//
  app.post("/api/admin_show_allClip_new", allBapi.admin_show_allClip_new, error);
  //=================================All Images==============================//
  app.post("/api/admin_show_allImages_new", allBapi.admin_show_allImages_new, error);

  //================================ALl subscription==============================//
  app.post("/api/allsubscriber_new", allBapi.allsubscriber_new, error);

  //new creator ==////////////////////
  app.post("/api/admin_show_creator_new", allBapi.admin_show_creator_new, error);
